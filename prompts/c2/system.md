...
# 6. Output
Return only this JSON object, with no text before or after it, and write "verdict" FIRST, before "short_reason":
{"verdict": "consistent" | "inconsistent" | "unsure", "short_reason": "<at most 25 words>"}
For "inconsistent" or "unsure", short_reason names the conflicting columns and their exact values. For "consistent", short_reason is "no conflict".
